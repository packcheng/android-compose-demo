...
package com.packcheng.demo.news.ui.components
...
import com.packcheng.demo.news.ui.ZbcNewsDestinations
...
fun AppNavRail(
    ...
    NavigationRail(
        ...
        NavigationRailItem(
            selected = currentRoute == ZbcNewsDestinations.HOME_ROUTE,
        ...
        NavigationRailItem(
            selected = currentRoute == ZbcNewsDestinations.INTERESTS_ROUTE,
...
fun PreviewAppNavRail() {
    ZbcNewsTheme() {
        AppNavRail(
            currentRoute = ZbcNewsDestinations.HOME_ROUTE,
            navigateToHome = {},
            navigateToInterests = {},
        )
    }
