...
package com.packcheng.demo.snack.ui.theme
...
object ZbcSnackTheme {
    val colors: JetsnackColors
        @Composable
        get() = LocalZbcSnackColors.current
}
...
fun ProvideZbcSnackColors(
    ...
    CompositionLocalProvider(LocalZbcSnackColors provides colorPalette, content = content)
}

private val LocalZbcSnackColors = staticCompositionLocalOf<JetsnackColors> {
    error("No ZbcSnackColorPalette provided")
}

/**
 * A Material [Colors] implementation which sets all colors to [debugColor] to discourage usage of
 * [MaterialTheme.colors] in preference to [ZbcSnackTheme.colors].
 */
fun debugColors(
    darkTheme: Boolean,
